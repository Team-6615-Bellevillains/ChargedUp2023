...
public class SwerveJoystickCmd extends CommandBase {
    ...
    public void execute() {
         ...
         * the input to 0.
         */
        xSpeed = Math.abs(xSpeed) > OIConstants.kDriverControllerLeftYDeadband ? xSpeed : 0.0;
        ySpeed = Math.abs(ySpeed) > OIConstants.kDriverControllerLeftXDeadband ? ySpeed : 0.0;
